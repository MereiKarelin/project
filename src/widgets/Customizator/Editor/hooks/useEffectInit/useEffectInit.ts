...
import { CropToolGroup } from '@/widgets/Customizator/Editor/consts';
import {
  EventBus,
  HistoryManager,
  KeyManager,
...
import { move, moveInside, moveOutside, onResize } from '@/widgets/Customizator/Editor/utils';
import {
  removeElements,
  setSelectedTargets,
...
import {
  ...
  undoMove,
  undoSelectTargets,
} from '@/widgets/Customizator/Editor/utils/RestoreActions';
...
export const useEffectInit = (
  ...
  useEffect(() => {
    ...
    toolManager.setSelectedGroupTool(CropToolGroup.tools[0]);
