import { Context, createElement, ReactNode } from 'react';
...
export default function ContextConsumers<T extends Record<string, Context<any>>>(
  props: ContextConsumersProps<T>,
) {
